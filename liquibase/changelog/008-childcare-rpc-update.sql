...
-- =============================================
-- 008 : Mise à jour RPC listings_within_radius
--       pour inclure les champs garde d'enfant
-- =============================================

-- DROP requis : CREATE OR REPLACE ne peut pas changer le type de retour
--changeset neighborshare:008-drop-rpc-before-childcare splitStatements:false
drop function if exists listings_within_radius(double precision, double precision, double precision);

--changeset neighborshare:008-rpc-listings-within-radius-childcare splitStatements:false
...
--changeset neighborshare:008-reload-schema-cache
